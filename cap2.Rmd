...
```{r img2_5_1, fig.align='center', fig.cap= "**Diagrama 1. División en dos a partir de una colmena**", echo=FALSE, out.width = "70%", cache=TRUE}
 #par(mfrow = c(2, 2),
...
```{r img2_5_2, fig.align='center', fig.cap= "**Diagrama 2. Método de abanico**", echo=FALSE, out.width = "70%", cache=TRUE}
 #par(mfrow = c(2, 2),
...
```{r img2_5_3, fig.align='center', fig.cap= "**Diagrama 3. Método provenzal**", echo=FALSE, out.width = "70%", cache=TRUE}
 #par(mfrow = c(2, 2),
