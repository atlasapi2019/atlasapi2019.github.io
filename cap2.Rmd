...
<p align="center"> **Cuadro 1. Asociaciones, cámaras, instituciones y publicaciones relacionadas con la apicultura.** [`r icon::fa("download")`](tabs/asociaciones_api2.csv) </p>
...
```{r i0_2_16_01, fig.align='center', fig.cap="**Fig. 7 Abeja reina ovipositando**", echo=FALSE, out.width = "50%", cache=TRUE}
