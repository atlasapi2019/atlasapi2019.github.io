...
## 4.2. Producción de Miel por Entidad de 2003 a 2018 
****
...
names(bx3) <- estados
bx3$years <- c("2003","2004","2005","2006","2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018")
...
p1 <- plot_ly(bx3, x = ~years, y = ~AGS, name = 'Aguascalientes', type = 'scatter', mode = 'lines',
  ...
  layout(title = "Gráfica 2. Producción de Miel por Entidad Federativa, 2003-2018",
...
## 4.3. Otras Estadísticas por Entidad Federativa.
****
...
##  4.4. Balanza Comercial de México. Importación y Exportación   
****
...
<p align="center"> **Cuadro 13. Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>
